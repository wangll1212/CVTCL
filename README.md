...
* Note: I created these lmdb files with msgpack==0.6.2, when load them with msgpack>=1.0.0, you can do `msgpack.loads(raw_data, raw=True)`((https://github.com/TengdaHan/CoCLR/issues/32))
